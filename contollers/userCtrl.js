...
validateMongoDbId(_id);
 ...
 const forgotPasswordToken = asyncHandler(async (req,res) => {
    ...
    try {
        ...
        await user.save();
        const resetURL = `Hi, Please follow this link to reet Your Password. This link is valid fill 10 minutes from now. <a href='http://localost:5000/api/user/reset-password/${token}'>Click here</a>`;
        const data = {
            to:email,
            text:"Hey User",
